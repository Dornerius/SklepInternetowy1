...
namespace SklepIntranet.Controllers
{
    public class ProductTypeController : Controller
    {
        ...
        public ProductTypeController(SklepIntranetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProductType,ProductTypeName,ProductTypeSubName,Description")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProductType,ProductTypeName,ProductTypeSubName,Description")] ProductType productType)
        {
